            ...
            <div className="container">
                <div className="row">
                    ...
                    >
                        ...
                        <p className='text-center text-sm-start'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit reiciendis aperiam nihil commodi a omnis facere illo! Dolore, at provident.</p>

                        <div>
                            <button className='btn btn-light btn-lg rounded-0 text-capitalize me-3'>
                                Get Started</button>
                            <button className='btn btn-outline-light btn-lg rounded-0 text-capitalize'>
                                Learn More</button>
